...
public class YandexAIService implements AiService {
    ...
    private static final String gptPrompt = """
            ...
            4. Каждый вопрос должен содержать от 1 до 5 вариантов ответа. 
            ...
            Не додумывай дополнительную информацию по другим темам, которые не указаны в изначальном тексте.
            """;
